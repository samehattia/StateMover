...
def set_lram_value_in_partial_bit_file(lram_x, lram_y, lram_l, lram_width, lram_value, partial_file, partial_start_address, partial_start_byte, lutrams):
...
def set_named_lram_value_in_bit_file(lram_name, lram_value, file, start_byte, lutrams, rams):
