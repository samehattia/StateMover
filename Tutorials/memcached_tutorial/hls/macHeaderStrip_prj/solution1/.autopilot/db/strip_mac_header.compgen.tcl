...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { IPdataOut_TDATA { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { IPdataOut_TKEEP { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { IPdataOut_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { IPdataOut_TREADY { I 1 bit } IPdataOut_TVALID { O 1 bit } IPdataOut_TUSER { O 112 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ipDataFifo_V_dout { I 185 vector } ipDataFifo_V_empty_n { I 1 bit } ipDataFifo_V_read { O 1 bit } } \
} "
}
