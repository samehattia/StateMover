...
# FIFO definition:
set ID 13
set FifoName fifo_w185_d16_A
set InstName dataFifo_V_U
...
set InstName dataLenFifo_V_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 15
set FifoName start_for_edit_len_field_U0
set InstName start_for_edit_len_field_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dataOut_TUSER { O 112 vector } dataOut_TVALID { O 1 bit } dataOut_TREADY { I 1 bit } } \
} "
} else {
