...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("rdCmdIn_V_TDATA", 48, hls_in, 0, "axis", "in_data", 1),
	Port_Property("rdDataOut_V_V_TDATA", 64, hls_out, 1, "axis", "out_data", 1),
	Port_Property("wrCmdIn_V_TDATA", 48, hls_in, 2, "axis", "in_data", 1),
	Port_Property("wrDataIn_V_V_TDATA", 64, hls_in, 3, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "flashModel";
