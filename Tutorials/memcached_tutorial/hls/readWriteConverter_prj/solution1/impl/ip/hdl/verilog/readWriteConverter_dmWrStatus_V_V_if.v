...
module readWriteConverter_dmWrStatus_V_V_if (
    // AXI4-Stream singals
    input  wire       ACLK,
    input  wire       ARESETN,
    input  wire       TVALID,
...
//------------------------Instantiation------------------
// rs
readWriteConverter_dmWrStatus_V_V_reg_slice #(
    .N       ( 8 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// dmWrStatus_V_V_fifo
readWriteConverter_dmWrStatus_V_V_fifo #(
    .DATA_BITS  ( 8 ),
    .DEPTH_BITS ( 4 )
) dmWrStatus_V_V_fifo (
    .clk        ( ACLK ),
...
module readWriteConverter_dmWrStatus_V_V_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module readWriteConverter_dmWrStatus_V_V_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
