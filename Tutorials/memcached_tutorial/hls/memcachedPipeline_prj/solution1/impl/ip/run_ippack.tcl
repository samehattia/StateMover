...
set Library     "hls"
set IPName      "memcachedPipeline"
set Version     "1.07"
set DisplayName "Combined Binary Flash/DRAM Memcached Pipeline"
set Revision    "2010211219"
set Description "A 4 stage memcached pipeline with SSD & DRAM value stores supporting only the binary protocol"
set Device      "kintexu"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "memcachedPipeline"
...
set Interfaces {
    ...
    dramValueStoreMemRdCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "dramValueStoreMemRdCmd_V"
        has_tready "1"
        ports {
            TDATA 40
        }
    ...
    dramValueStoreMemRdData_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "dramValueStoreMemRdData_V_V"
        has_tready "1"
        ports {
            TDATA 512
        }
    ...
    dramValueStoreMemWrCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "dramValueStoreMemWrCmd_V"
        has_tready "1"
        ports {
            TDATA 40
        }
    ...
    dramValueStoreMemWrData_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "dramValueStoreMemWrData_V_V"
        has_tready "1"
        ports {
            TDATA 512
        }
    ...
    flashValueStoreMemRdCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "flashValueStoreMemRdCmd_V"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    flashValueStoreMemRdData_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "flashValueStoreMemRdData_V_V"
        has_tready "1"
        ports {
            TDATA 64
        }
    ...
    flashValueStoreMemWrCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "flashValueStoreMemWrCmd_V"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    flashValueStoreMemWrData_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "flashValueStoreMemWrData_V_V"
        has_tready "1"
        ports {
            TDATA 64
        }
    ...
    hashTableMemRdData_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "hashTableMemRdData_V_V"
        has_tready "1"
        ports {
            TDATA 512
        }
    ...
    hashTableMemRdCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "hashTableMemRdCmd_V"
        has_tready "1"
        ports {
            TDATA 40
        }
    ...
    hashTableMemWrData_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "hashTableMemWrData_V_V"
        has_tready "1"
        ports {
            TDATA 512
        }
    ...
    hashTableMemWrCmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "hashTableMemWrCmd_V"
        has_tready "1"
        ports {
            TDATA 40
        }
    ...
    addressReturnOut_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "addressReturnOut_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    addressAssignDramIn_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "addressAssignDramIn_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    addressAssignFlashIn_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "addressAssignFlashIn_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "inData outData dramValueStoreMemRdCmd_V dramValueStoreMemRdData_V_V dramValueStoreMemWrCmd_V dramValueStoreMemWrData_V_V flashValueStoreMemRdCmd_V flashValueStoreMemRdData_V_V flashValueStoreMemWrCmd_V flashValueStoreMemWrData_V_V hashTableMemRdData_V_V hashTableMemRdCmd_V hashTableMemWrData_V_V hashTableMemWrCmd_V addressReturnOut_V_V addressAssignDramIn_V_V addressAssignFlashIn_V_V"
    }
    ap_rst_n {
        type "reset"
        polarity "ACTIVE_LOW"
...
## System Info
set user_parameters_list {clk_period 6.660000 machine 64 combinational 0 latency 5 II x}
