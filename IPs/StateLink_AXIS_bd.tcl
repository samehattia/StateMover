...
################################################################
# This is a generated script based on design: StateLink_AXIS
#
...
# source StateLink_AXIS_script.tcl
...
set design_name StateLink_AXIS
...
proc create_hier_cell_StateLink_AXIS_0 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_switch_1_M01_AXIS [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins axis_switch_1/M01_AXIS]
  ...
  connect_bd_net -net ddr4_0_addn_ui_clkout1 [get_bd_pins axis_clk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins axis_switch_1/aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_1/aclk] [get_bd_pins ti_trans_axis_wrapper_0/m00_axis_aclk] [get_bd_pins ti_trans_axis_wrapper_0/s01_axis_aclk] [get_bd_pins vio_0/clk]
  connect_bd_net -net decouple_1_1 [get_bd_pins decouple_1] [get_bd_pins axis_switch_1/s_axis_tdest] [get_bd_pins ti_trans_axis_wrapper_0/decouple]
  connect_bd_net -net rst_ddr4_0_150M_peripheral_aresetn [get_bd_pins axis_rst_n] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axis_switch_0/aresetn] [get_bd_pins axis_switch_1/aresetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins jtag_axi_1/aresetn] [get_bd_pins ti_trans_axis_wrapper_0/m00_axis_aresetn] [get_bd_pins ti_trans_axis_wrapper_0/s01_axis_aresetn]
