...
################################################################
# This is a generated script based on design: StateLink_AXIS_Ethernet
#
...
# source StateLink_AXIS_Ethernet_script.tcl
...
set design_name StateLink_AXIS_Ethernet
...
proc create_root_design { parentCell } {
  ...
  set data_out_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 data_out_0_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {150000000} \
   CONFIG.PHASE {0} \
   ] $data_out_0_0
  ...
  connect_bd_intf_net -intf_net StateLink_AXIS_0_data_out_0 [get_bd_intf_ports data_out_0_0] [get_bd_intf_pins StateLink_AXIS_0/data_out_0]
  connect_bd_intf_net -intf_net data_in_0_1 [get_bd_intf_ports data_in_0] [get_bd_intf_pins StateLink_AXIS_0/data_in]
