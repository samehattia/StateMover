...
proc init_gui { IPINST } {
  ...
  set C_M01_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_M01_AXIS_TDATA_WIDTH" -parent ${Page_0}]
  ...
  set C_S01_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_S01_AXIS_TDATA_WIDTH" -parent ${Page_0}]
