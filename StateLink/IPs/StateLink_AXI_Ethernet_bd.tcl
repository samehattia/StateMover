...
################################################################
# This is a generated script based on design: StateLink_AXI_Ethernet
#
...
# source StateLink_AXI_Ethernet_script.tcl
...
set design_name StateLink_AXI_Ethernet
...
proc create_root_design { parentCell } {
  ...
  set data_out_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 data_out_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {150000000} \
   CONFIG.PHASE {0} \
   ] $data_out_0
  ...
  connect_bd_intf_net -intf_net StateLink_AXI_0_data_out [get_bd_intf_ports data_out_0] [get_bd_intf_pins StateLink_AXI_0/data_out]
  connect_bd_intf_net -intf_net data_in_0_1 [get_bd_intf_ports data_in_0] [get_bd_intf_pins StateLink_AXI_0/data_in]

  # Create port connections
  connect_bd_net -net StateLink_AXI_0_stop_ack_0 [get_bd_ports stop_ack_0_0] [get_bd_pins StateLink_AXI_0/stop_ack_0]
  connect_bd_net -net ap_clk_0_1 [get_bd_ports ap_clk_0] [get_bd_pins StateLink_AXI_0/ap_clk]
  connect_bd_net -net ap_rst_n_0_1 [get_bd_ports ap_rst_n_0] [get_bd_pins StateLink_AXI_0/ap_rst_n]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces StateLink_AXI_0/ethernet_axi_0/Data_m_axi_mem_V] [get_bd_addr_segs M00_AXI_0/Reg] SEG_M00_AXI_0_Reg
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs M00_AXI_0/Reg] SEG_M00_AXI_0_Reg
