...
set Library     "hls"
set IPName      "axi_timestamper"
set Version     "1.0"
set DisplayName "Axi_timestamper"
set Revision    "2112592697"
set Description "An IP generated by Vivado HLS"
set Device      "kintexu"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "axi_timestamper"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {axi_timestamper_timestamp_s_axi
axi_timestamper
}
set kernel_xo ""

## Variables
set Top "axi_timestamper"
set TopNoPrefix "axi_timestamper"
...
set Interfaces {
    s_axi_timestamp {
        ...
        addr_bits "32"
        port_width "AWADDR 32 WDATA 32 WSTRB 4 ARADDR 32 RDATA 32"
        registers {{0x80000000 write_timestamp_V R 0x0 "Data signal of write_timestamp_V" {{0 32 write_timestamp_V R 0 "Bit 31 to 0 Data signal of write_timestamp_V"}}} {0x80000004 write_timestamp_V_ctrl R 0x0 "Control signal of write_timestamp_V" {{0 1 write_timestamp_V_ap_vld R 0 "Control signal write_timestamp_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80000010 read_timestamp_V R 0x0 "Data signal of read_timestamp_V" {{0 32 read_timestamp_V R 0 "Bit 31 to 0 Data signal of read_timestamp_V"}}} {0x80000014 read_timestamp_V_ctrl R 0x0 "Control signal of read_timestamp_V" {{0 1 read_timestamp_V_ap_vld R 0 "Control signal read_timestamp_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.3 machine 64 combinational 0 latency 0 II 1}
