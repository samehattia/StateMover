...
################################################################
# This is a generated script based on design: StateLink_AXI
#
...
# source StateLink_AXI_script.tcl
...
proc create_hier_cell_StateLink_AXI_0 { parentCell nameHier } {
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins sys_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins ti_transp_axi_wrapper_0/m00_axi_aclk]
  connect_bd_net -net decouple_0_1 [get_bd_pins decouple_0] [get_bd_pins ti_transp_axi_wrapper_0/decouple]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins sys_rst_n] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins ti_transp_axi_wrapper_0/m00_axi_aresetn]
